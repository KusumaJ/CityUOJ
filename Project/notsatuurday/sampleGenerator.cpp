...
int main(int argc, char **argv)
{
    ...
    // discrete_distribution<unsigned int> optGen({40, 40, 20}); 
    
    // generator for no. of {search, insert, delete}, 40% search, 40% insert, 20% delete. 
    ...
    for (unsigned int i = 0; i < 500; i++)
    {
        ...
        unsigned int opt = 2*i*i%3;
        unsigned int val = 3*(i*i*i+3)%20; 
